...
$string['keytype_help'] = 'Selects the method of authentication to be used to validate the tool\'s messages.';
...
$string['redirectmobile'] = 'Force redirect when mobile.';
$string['redirectmobile_help'] = 'Forcefully redirect the launch to a new window when in mobile or tablet mode, to allow for better visualization.';
